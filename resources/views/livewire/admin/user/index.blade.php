<div class="row" wire:key='update-user-form'>
 ...
 <div class="col-12">
  ...
  <x-base.card title="Users">
   <x-slot name='action'>
    <x-modal-button key='create-user' class="btn  btn-primary" href="{{ route('category.create') }}">Create
    </x-modal-button>
   </x-slot>
    ...
    <x-slot name="tbody">
     ...
     <tr wire:key="item-{{ $user->id }}">
      ...
      <td class="w-full d-flex" style="justify-content: space-around">
       ...
       <x-modal-button wire:key="userEdit-{{ $user->id }}" wire:click="editUser({{ $user->id }})"
        class="btn-info btn-xs btn" key="update-user">
 ...
 <x-modal wire:ignore.self title="Update" key="update-user" data-backdrop="static" livewireClose='closeModal'>
  ...
  <form wire:submit.prevent="updateUser">
   ...
   <div wire:loading.remove>
    @include('components.users.form', [ "btnTitle"=> "Update", "title"=> "Update User"])
   ...
   <div class="modal-content">
    ...
    <form wire:submit.prevent="createUser">
     <div class="modal-body">
      @include('components.users.form', [ "btnTitle"=> "Update", "title"=> "Create User"])
     </div>
