            ...
            <x-base.form :action="$route" autocomplete="on" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <x-base.form-group label="Title" class="col-md-6">
                        <x-base.input :value="old('title')?? optional($category)->title" id="title" name="title"
                            type="text" />
                    </x-base.form-group>
                    <x-base.form-group label="Slug" class="col-md-6">
                        <x-base.input :value="old('slug')?? optional($category)->slug" id="slug" name="slug"
                            type="text" />
                    </x-base.form-group>
                    <x-base.form-group label="Description" class="col-md-12">
                        <x-base.textarea :value="old('description')" id="description" name="description">{{
                            optional($category)->description }}</x-base.textarea>
                    </x-base.form-group>
                    ...
                    <x-base.form-group label="Image" class="col-md-6">
                        <x-base.input :value="old('image')" id="image" name="image" type="file" />
                    </x-base.form-group>
                </div>
